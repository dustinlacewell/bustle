...
rm docs/static/characters.json
rm docs/static/textures.json
rm docs/static/sounds.json
rm docs/static/gamemodes.json
rm docs/static/stages.json
rm docs/static/tweaks.json
rm docs/static/tools.json
rm docs/static/overhauls.json
rm docs/static/clientside.json
# rm docs/static/style.json
